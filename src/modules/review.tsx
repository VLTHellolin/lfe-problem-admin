...
const Panel = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener('luogu:admin:article-review', articleReviewHandler);
    };
  ...
  return (
    <>
      <Button theme='primary' spacing onClick={() => {
        setModalShown(true);
      }}
      >
        历史记录
      ...
      {modalShown && (
        <Modal header='历史记录' long onSuccess={() => {
          setModalShown(false);
        }}
        >
          <div>
