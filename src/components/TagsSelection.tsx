...
export const TagsSelection = forwardRef<HTMLDivElement, TagsSelectionProps>(
  ({ className, tags, value, onModify, ...props }, ref) => {
    const [filter, setFilter] = useState('');

    return (
      <div ref={ref} className={clsx('pa-tags', className)} {...props}>
